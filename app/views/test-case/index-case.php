                    ...
                    <li>
                        <div class="wrapper-suite">
                            <div class="wrapper-header position-relative">
                                <a href="<?= BASEURL; ?>testcase/testsuite/<?= $test_suite['id']; ?>" data-id="<?= $test_suite['id'] ?>" class="suite-header d-flex align-items-center justify-content-between position-relative">
                            ...
                            <ul class="list-move-section">
                                <!-- <?php foreach ($test_section[$i] as $section) : ?>
                                    <li>
                                        <?php $url = explode("/", $_GET['url']); ?>
                                        <div class="suite-menu position-relative <?= $_GET['url'] == 'testcase/testsection/' . $test_suite['id'] . '/' . $section['id'] ? 'active' : '' ?> <?= $_GET['url'] == 'testcase/testsection/' . $test_suite['id'] . '/' . $section['id'] ? 'active-bg' : '' ?>">
                                            <a href="<?= BASEURL; ?>testcase/testsection/<?= $test_suite['id']; ?>/<?= $section['id']; ?>" class="position-relative"><?= $section['name']; ?></a>
                                            <div class="wrapper-action action-section d-flex align-items-center">
                                                ...
                                                <div class="card-action d-flex position-relative">
                                                    ...
                                                    <button type="button" class="wrapper-icon" data-bs-toggle="modal" data-bs-target="#editSection" data-id="<?= $section['id']; ?>">
                                                        <div class="edit-icon"></div>
                                                    </button>
                                                    <button type="button" class="wrapper-icon" data-bs-toggle="modal" data-bs-target="#deleteSection" data-id="<?= $section['id']; ?>">
                                                        <div class="delete-icon"></div>
                                                    </button>
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function() {
        $(".suite-header").change(function() {
            suiteheader = $(this).data('id');
            console.log(suiteheader);
