        ...
        <div class="row">
            ...
            <div class="col p-0">
                <div class="card-login w-100 d-flex flex-column align-items-center">
                    ...
                    <form action="<?= BASEURL; ?>changePassword/changePasswordAction" method="post" style="width: 100%; gap: 24px;" class="d-flex flex-column">
                        ...
                        <button type="submit" class="button-login text-center">Change password</button>
                    </form>
